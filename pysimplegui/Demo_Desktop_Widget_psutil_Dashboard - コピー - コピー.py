...
def main():
    ...
    net_graph_in = DashGraph(net_in, net_io.bytes_recv, '#23a0a0')
    net_out = window['_NET_OUT_GRAPH_']
    net_graph_out = DashGraph(net_out, net_io.bytes_sent, '#56d856')
    disk_io = psutil.disk_io_counters()
    disk_graph_write = DashGraph(window['_DISK_WRITE_GRAPH_'], disk_io.write_bytes, '#be45be')
    disk_graph_read = DashGraph(window['_DISK_READ_GRAPH_'], disk_io.read_bytes, '#5681d8')
