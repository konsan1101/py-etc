...
if __name__ == "__main__":
    ...
    excel.Workbooks.Open(Filename="C:/Users/kondou/Documents/GitHub/py-etc/vba/test_excel2.xlsm", ReadOnly=1)  # ブックを読み取り専用で開く
    excel.Application.Run('public_access')  # マクロ名を指定して実行（引数なしの場合マクロ名のみで実行可能）
